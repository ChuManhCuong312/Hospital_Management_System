...
public class PatientService {
        ...
        try {
            ...
            for (Patient patient : patients) {
                if (patient.getId().equalsIgnoreCase(id)) {
                    // Validate dữ liệu mới trước khi cập nhật
    ...
    public String updatePatientFromInput(Scanner scanner) {
        try {
            ...
            // Giữ nguyên giá trị cũ nếu không nhập mới
            ...
            if (!newAgeStr.trim().isEmpty()) {
                try {
                    ...
                    System.out.println("⚠️  Tuổi không hợp lệ, giữ nguyên tuổi cũ: " + existingPatient.getAge());
                }
            }
    ...
    public String importFromFile(String fileName) {
        try {
            ...
            return "✅ Import thành công " + importedCount + " bệnh nhân. " + 
                   (errorCount > 0 ? "⚠️  " + errorCount + " dòng lỗi." : "");
